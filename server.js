...
app.get("/player_info/post", function(req, res){
  var query1 = req.query.player_choice
  var q2 = 'select id, name from football_players;'
  var q3 = 'select * from football_players where id = "+ query1 +"; '
  var q4 = 'select count(*) from football_players join football_games on football_players.id = "+ query1 + " and football_players.id = any(football_games.players);'
  db.task('get everything', task => {
    return task.batch([
      task.any(q2),
      task.any(q3),
